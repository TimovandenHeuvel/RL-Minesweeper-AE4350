...
RUN_TITLE = 'CNN_with_transfer_3stage_6x6_345_30000epi_s2epst05epdc09995'
...
def save_results_csv(win_rates, reward_avgs, stage_switches, last_eval_rate, tag="cnn_with_transfer"):
    ...
    # with open("results/total_data.csv", "w", newline='') as f:
    #     writer = csv.writer(f)
    #     writer.writerow(["STAGE", "EPISODE", "WIN RATE", "AVG REWARD", "EPSILON"])
    #     for i in enumerate(win_rates):
    #         writer.writerow([win_rates(i),reward_avgs(i)])
